...
| B10 | `crates/seam/tests/acceptance_b_estimator.rs::b10_confidence_matches_closed_form_and_scipy_grid`; `crates/seam/tests/acceptance_b_estimator.rs::b10_round_exposes_test_compliance_fraction` | passing |
