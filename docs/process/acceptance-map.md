...
| B5 | `crates/seam/tests/acceptance_b_estimator.rs::b5_selects_smallest_clearing_ef_40`; `crates/seam/tests/acceptance_b_estimator.rs::b5_more_evidence_can_reduce_the_selected_ef`; `crates/seam/tests/acceptance_b_estimator.rs::b5_rejects_invalid_direct_aggregation_confidence`; `crates/seam/tests/acceptance_b_estimator.rs::b5_selection_requires_train_confidence_not_only_a_clearing_quantile`; `crates/seam/tests/acceptance_b_estimator.rs::b5_holdout_below_target_carries_effective_recommendation`; `crates/seam/tests/acceptance_b_estimator.rs::b5_selection_gate_above_approval_gate_picks_a_higher_ef`; `crates/seam/tests/acceptance_b_estimator.rs::b5_split_sizes_make_the_same_compliance_less_confident_on_holdout` | passing |
| B6 | `crates/seam/tests/acceptance_b_estimator.rs::b6_target_unmet_is_decided_by_the_highest_ef`; `crates/seam/tests/acceptance_b_estimator.rs::b6_target_unmet_reports_max_ef_and_carries_effective_recommendation` | passing |
| B7 | `crates/seam/src/config.rs::tests::derived_split_minimum_inverts_the_confidence_ceiling`; `crates/seam/tests/acceptance_b_estimator.rs::b7_split_one_below_assurance_minimum_is_insufficient`; `crates/seam/tests/acceptance_b_estimator.rs::b7_splits_at_assurance_minimum_emit_recommendation`; `crates/seam/tests/acceptance_b_estimator.rs::b7_realized_empty_split_is_insufficient_even_when_ceiling_clears`; `crates/seam/tests/acceptance_b_estimator.rs::b7_unattainable_assurance_is_insufficient_not_target_unmet` | passing |
...
| B10 | `crates/seam/tests/acceptance_b_estimator.rs::b10_confidence_matches_closed_form_and_scipy_grid`; `crates/seam/tests/acceptance_b_estimator.rs::b10_round_exposes_train_and_test_compliance_fractions` | passing |
...
| C3 | `crates/seam/tests/acceptance_c_durability.rs::c3_config_fingerprint_k_change_ignores_incompatible_intermediate`; `crates/seam/tests/acceptance_c_durability.rs::c3_unknown_intermediate_format_version_is_incompatible`; `crates/seam/src/pipeline.rs::tests::c3_config_fingerprint_remeasures_and_retains_incompatible_count` | passing |
...
| E2 | `crates/seam/src/pipeline.rs::tests::e2_target_unmet_and_insufficient_rounds_carry_effective` | passing |
